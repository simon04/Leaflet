!(function (e) {
  ...
  function f(e, t, a, i) {
    ...
    function v(e, t) {
      var r = e.cN ? h(e.cN, "", !0) : "";
      (e.rB ? ((k += r), (B = "")) : e.eB ? ((k += n(t) + r), (B = "")) : ((k += r), (B = t)),
    ...
    function m(e, t) {
      ...
      if (a) {
        var i = L;
        (i.rE || i.eE || (B += t), (k += b()));
        do (L.cN && (k += "</span>"), (y += L.r), (L = L.parent));
        while (L != a.parent);
  ...
  function h(e, n, t) {
    var r = n ? R[n] : t,
      a = [e.trim()];
    return (
      e.match(/\bhljs\b/) || a.push("hljs"), -1 === e.indexOf(r) && a.push(r), a.join(" ").trim()
    );
  }
  function p(e) {
    var n = i(e);
    ...
    c: [
      ...
      },
      {
        ...
        c: [
          ...
          { cN: "params", b: /\(/, e: /\)/, eB: !0, eE: !0, c: [e.CLCM, e.CBCM], i: /["'\(]/ },
        ],
        i: /\[|%/,
      },
      { b: /\$[(.]/ },
