...
- [ ] Download TGZ archive from https://registry.npmjs.org/leaflet/-/leaflet-X.X.X.tgz (where `X.X.X` is the new version number) and upload it as an "asset" of the GitHub release.
