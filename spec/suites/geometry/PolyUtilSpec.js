...
describe("PolyUtil", () => {
  describe("#clipPolygon", () => {
    it("clips polygon by bounds", () => {
      ...
      const points = [new Point(5, 5), new Point(15, 10), new Point(10, 15)];
  ...
  describe("#polygonCenter", () => {
    ...
    it("computes center of a small polygon", () => {
      const latlngs = [
        [42.87097909758862, -81.12594320566181],
        [42.87108302016597, -81.12594320566181],
        [42.87108302016597, -81.12576504805303],
        [42.87097909758862, -81.12576504805303],
      ];
