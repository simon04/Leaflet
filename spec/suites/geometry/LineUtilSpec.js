...
describe("LineUtil", () => {
  ...
  describe("#simplify", () => {
    it("simplifies polylines according to tolerance", () => {
      ...
      expect(simplified).to.eql([new Point(0, 0), new Point(1, 0), new Point(2, 1)]);
    });
  });
  ...
  describe("#polylineCenter", () => {
    ...
    it("computes center of a small line", () => {
      const latlngs = [
        [50.49898323576035, 30.509834789772036],
        [50.49998323576035, 30.509834789772036],
        [50.49998323576035, 30.509939789772037],
        [50.49898323576035, 30.509939789772037],
      ];
