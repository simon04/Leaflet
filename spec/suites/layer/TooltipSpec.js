...
describe("Tooltip", () => {
  ...
  it("can be forced on left direction", () => {
    ...
    layer.bindTooltip("A long tooltip that should be displayed on the left", {
      permanent: true,
      direction: "left",
      interactive: true,
    });
  ...
  it("can be forced on top direction", () => {
    ...
    layer.bindTooltip("A tooltip that should be displayed on the top", {
      permanent: true,
      direction: "top",
      interactive: true,
    });
  ...
  it("can be forced on center", () => {
    ...
    layer.bindTooltip("A tooltip that should be displayed on the center", {
      permanent: true,
      direction: "center",
      interactive: true,
    });
  ...
  it.skipIfNotTouch(
    "is closed if not permanent when clicking on the map elsewhere on touch",
    () => {
      const layer = new Marker(center).addTo(map);
  ...
  it("adds tooltip with passed content in options while initializing", () => {
    const tooltip = new Tooltip(center, { content: "Test" }).addTo(map);
    expect(map.hasLayer(tooltip)).to.be.true;
  ...
  it("removes focus listeners after unbinding tooltip from Layer", () => {
    ...
    marker.bindTooltip("Tooltip that will be unbinded").openTooltip();
  ...
  it("removes focus listeners after unbinding tooltip from FeatureGroup", () => {
    ...
    layergroup.bindTooltip("Tooltip that will be unbinded in two seconds").openTooltip();
