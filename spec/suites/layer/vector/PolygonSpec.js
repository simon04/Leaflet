...
describe("Polygon", () => {
  ...
  describe("#addLatLng", () => {
    ...
    it("should add latlng on first latlngs by default on a multipolygon with hole", () => {
      ...
      expect(poly._latlngs[0][0]).to.eql([
        new LatLng([0, 10]),
        new LatLng([10, 10]),
        new LatLng([10, 0]),
        new LatLng([-10, -10]),
      ]);
      expect(poly._latlngs[0][1]).to.eql([
        new LatLng([2, 3]),
        new LatLng([2, 4]),
        new LatLng([3, 4]),
      ]);
      expect(poly._latlngs[1][0]).to.eql([
        new LatLng([10, 20]),
        new LatLng([30, 40]),
        new LatLng([50, 60]),
      ]);
    ...
    it("should add latlng by reference on a multipolygon with hole", () => {
      ...
      expect(poly._latlngs[1][1]).to.eql([
        new LatLng([2, 3]),
        new LatLng([2, 4]),
        new LatLng([3, 4]),
        new LatLng([2, 2]),
